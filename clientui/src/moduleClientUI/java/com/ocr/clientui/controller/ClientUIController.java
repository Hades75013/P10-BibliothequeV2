...
public class ClientUIController {
    ...
    public String OuvragesDetails (int idOuvrage, Model model){
        ...
        model.addAttribute("ouvrage",libraryProxyService.afficherUnOuvrage(idOuvrage));
    ...
    public String Ouvrage (@PathVariable("id")int id, Model model){

        OuvrageBean ouvrage = libraryProxyService.afficherUnOuvrage(id);
